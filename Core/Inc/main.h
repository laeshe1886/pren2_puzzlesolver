...
#define STEPPER_X_NFAULT_Pin GPIO_PIN_6
#define STEPPER_X_NFAULT_GPIO_Port GPIOE
#define DIN_12_Pin GPIO_PIN_0
#define DIN_12_GPIO_Port GPIOF
#define DIN_10_Pin GPIO_PIN_1
#define DIN_10_GPIO_Port GPIOF
#define DIN_8_Pin GPIO_PIN_2
#define DIN_8_GPIO_Port GPIOF
#define DOUT_2_Pin GPIO_PIN_3
#define DOUT_2_GPIO_Port GPIOF
#define STEPPER_ROT_NSLEEP_Pin GPIO_PIN_5
#define STEPPER_ROT_NSLEEP_GPIO_Port GPIOF
#define STEPPER_ROT_STEP_Pin GPIO_PIN_6
#define STEPPER_ROT_STEP_GPIO_Port GPIOF
#define DIN_7_Pin GPIO_PIN_7
#define DIN_7_GPIO_Port GPIOF
#define DIN_5_Pin GPIO_PIN_8
#define DIN_5_GPIO_Port GPIOF
#define DIN_9_Pin GPIO_PIN_9
#define DIN_9_GPIO_Port GPIOF
#define DIN_4_Pin GPIO_PIN_10
#define DIN_4_GPIO_Port GPIOF
#define STEPPER_X_NSLEEP_Pin GPIO_PIN_0
#define STEPPER_X_NSLEEP_GPIO_Port GPIOA
...
#define DIN_6_Pin GPIO_PIN_9
#define DIN_6_GPIO_Port GPIOE
#define STEPPER_Y_DIR_Pin GPIO_PIN_10
...
#define STEPPER_Y_M0_Pin GPIO_PIN_11
#define STEPPER_Y_M0_GPIO_Port GPIOD
#define STEPPER_Y_STEP_Pin GPIO_PIN_12
...
#define STEPPER_ROT_DIR_GPIO_Port GPIOB
#define STEPPER_ROT_M1_Pin GPIO_PIN_7
#define STEPPER_ROT_M1_GPIO_Port GPIOB
#define STEPPER_X_M0_Pin GPIO_PIN_0
#define STEPPER_X_M0_GPIO_Port GPIOE
